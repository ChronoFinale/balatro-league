...
// match model in sync — the transitional DUAL-WRITE of the expand/contract
// migration (removed at the contract stage, when Match becomes the source of
// truth written directly).
//
...
// on each recompute is cheap. The Stage-1 backfill endpoint reuses this.
