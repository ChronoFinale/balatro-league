...
const STATIC_INTRO = [
  "# 🃏 Balatro League",
  "",
  "Each season you're put in a division by skill, then given a set of opponents to play (best-of-2). Run `/schedule` to see your matchups. Top of each division moves up next season, bottom moves down.",
  "",
